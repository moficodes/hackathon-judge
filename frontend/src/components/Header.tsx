      ...
      <div className="flex items-center gap-xl">
        ...
        <div className="flex items-center gap-md border-l border-slate-200 pl-xl cursor-pointer group">
          ...
          <div className="hidden md:flex flex-col">
            <span className="text-sm font-semibold text-slate-900 leading-tight">Judge User</span>
            <span className="text-[11px] text-slate-500 leading-tight">Technical Track</span>
          </div>
